...
const { siteURL, siteTitle, siteFacebookAdmins, siteFacebook, siteTwitter } =
  Info
    ...
    <Head>
      ...
      {images &&
        images
          .slice(0, 6)
          .map(d => (
            <meta key={'og:image_' + d} property="og:image" content={d} />
          ))}
      {date && (
        <meta property="og:updated_time" key="og:updated_time" content={date} />
      )}
      {audio && <meta property="og:audio" key="og:audio" content={audio} />}
      <meta property="og:locale" key="og:locale" content="en_US" />
      {siteTitle && (
        <meta property="og:site_name" key="og:site_name" content={siteTitle} />
      )}
      {videos &&
        videos
          .slice(0, 6)
      ...
      {siteFacebookAdmins && (
        <meta
          property="fb:admins"
          key="fb:admins"
          content={siteFacebookAdmins}
        />
      )}

      {/* Schema.org markup */}
      {description && (
        <meta itemProp="description" key="description" content={description} />
      )}
      {images &&
        images
          .slice(0, 6)
          .map(image => (
            <meta key={'image_' + image} itemProp="image" content={image} />
          ))}
      {tags && (
        <meta itemProp="keywords" key="keywords" content={tags.join(',')} />
      )}
      {wordCount && (
        <meta itemProp="wordCount" key="wordCount" content={wordCount} />
      )}

      {/* Twitter Cards */}
      <meta name="twitter:card" content="summary" key="twitter:card" />
      {siteTwitter && (
        <meta name="twitter:site" key="twitter:site" content={siteTwitter} />
      )}
      {title && (
