...
import { H1, H3, H4, Ol, P, Ul, Li } from 'components/Html'
...
export default function AcceptableUse() {
  return (
    <div>
      <Head
        title="Acceptable Use Policy | Nozzle"
        description="Acceptable Use Policy for Nozzle."
      />
      <div>
        <Center>
          <Top>
        ...
        <Body>
          <Container>
            <P>
              ...
              &ldquo;Products&rdquo;) provided by Nozzle under any ongoing
              agreement. It’s designed to protect us, our customers, and the
              general Internet community from unethical, irresponsible, and
              illegal activity.{' '}
            </P>
            <P>
              Nozzle customers found engaging in activities prohibited by this
            ...
            <P>This policy was last reviewed on 3 August 2021. </P>
            <H3>Fair use</H3>
            <P>
            ...
            <P>
              ...
              This includes but isn’t limited to facilitating the means to send
              spam and the initiation of network sniffing, pinging, packet
            ...
            <H4>Unauthorized use of Nozzle property</H4>
            <P>
              We prohibit the impersonation of Nozzle, the representation of a
              significant business relationship with Nozzle, or ownership of any
              Nozzle property (including our Products and brand) for the purpose
