            ...
            <div className='home'>
              <section className='section-1'>
                ...
                >
                  ...
                  <p>
                    If you want access to more enterprise level SERP data than
                    any tool has ever offered, you've come to the right place
                  </p>
              ...
              <section className='section-2' id='tracking'>
                ...
                <div className='right'>
                  ...
                  <p>
                    Most tools just tell you the top ranking page on your
                    domain. We monitor your entire brand, including social media
                    profiles and unlimited domain matches. There's a difference
                    between knowing you're ranking #1 and owning the entire
                    first page!
                  </p>
                  <p>
                    Unlimited access doesn't just refer to today's SERP. We keep
                    all your data FOREVER, so 3 years from now, you'll be able
                    to look back and see what was ranking for "Pokemon Go" in
                    2016. :)
                  </p>
                  <a className='btn btn-success' href='#contact'>
              ...
              <section className='section-3' id='data'>
                <div className='left'>
                  ...
                  <p>
                    ...
                    we’ll tell you your ad adjusted rank, how many pixels down
                    the page you are, whether a knowledge graph appeared and
                    even what your prospective customer ate for breakfast.
                  </p>
              ...
              <section className='section-4' id='competition'>
                ...
                <div className='right'>
                  <h3>
                    Squash your competitors... even the ones you don't know
                    about yet
                  </h3>
                  <h5>
                  ...
                  <p>
                    ...
                    them and we'll even rewrite history for you. It'll be like
                    you were monitoring them from the start!
                  </p>
                  <a className='btn btn-success' href='#contact'>
              ...
              <section className='section-5'>
                ...
                <div className='main'>
                  ...
                  <p>
                    ...
                    access your data the way you're used to. Even better, we
                    keep all your data forever, including the raw html. Consider
                    it necessary tooling when dealing with millions of keywords.
                    )
                  </p>
                  <a className='btn btn-success' href='#contact'>
              ...
              <section className='section-6' id='scheduling'>
                <div className='first'>
                  ...
                  <p>
                    Not all keywords are created equal. You're probably paying
                    too much to track your long-tail keywords daily or you're
                    only getting weekly data for your money making head terms.
                    Say goodbye to those tools and say hello to your new best
                    friend. Track your most important keywords daily, hourly or
                    even every 5 minutes. Keep an eye on thousands more by
                    scheduling them weekly or monthly without breaking the bank.
                  </p>
