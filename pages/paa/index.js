        ...
        <SectionKnowWhatQuestions>
          <div className="left">
            ...
            <P>Get a free or paid version of this deliverable below.
              What you'll get: 
              <ul>
                <li>200-800 questions from the People Also Ask boxes related to your specific keyword list</li>
                <li>The ability to filter by keyword group</li>
                <li>A drill down of your ranking URLs and where they rank for the phrases that generated the questions</li>
                <li>The percentage of time PAA boxes show up for your whole keyword set and each of your keyword groups</li>
              </ul>
            </P>
